...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-[28px] border border-white/10 bg-zinc-900/70 p-6 text-zinc-100 shadow-2xl shadow-black/40 backdrop-blur-lg",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-[28px] border border-slate-200/70 bg-white/95 p-6 text-slate-900 shadow-[0_25px_60px_-30px_rgba(15,23,42,0.65)] backdrop-blur",
    },
  },
  defaultVariants: {
    variant: "light",
