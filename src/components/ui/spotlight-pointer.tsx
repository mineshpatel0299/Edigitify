...
export function SpotlightPointer({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn(
        "pointer-events-none absolute rounded-full bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops),transparent_80%)] from-zinc-50 via-zinc-100 to-zinc-200 blur-xl transition-opacity duration-200",
